...
================================================================================
	...
	WHAT'S NEW?
			...
			- Added _SWITCH_USER functionality
         - Changed way of reading files (now, character by character)
         - Fixed the core bug in switch user
         - Included stdlib.h (random and randomize)
         - Added Encryption
         - COLOUR OF THE CONSOLE CHANGED!
...
void CALL_ENCRYPT();
void CALL_DECRYPT();
//USE SYSTEM("COLOR 1A") etc. NOW MAKE THE COLOR FUNCTION IN DEVR 1.0
void CALL_CONSOLE();
void CALL_COLOR();
int encrypt(char&);
...
void CALL_COLOR()
{
   ...
   strcpy(CONSOLE_COLOR, "Color ");
   strcat(CONSOLE_COLOR, TEMPest);
}
