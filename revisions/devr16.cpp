...
================================================================================
	...
	RECOMMENDED MINIMUM SYSTEM REQUIREMENTS:
			...
			RAM: At least 1 MB (requires more when handling files)
...
float version=1.6; // UPDATE THIS EVERY TIME!!!
fstream REGISTRY;
fstream HISTORY("core",fstream::app);

char INPUT[128];
char USER[32];
char EXE[11]="devr16.exe"; // UPDATE THIS EVERY TIME!!!
char APP_NAME[5]="devr";
...
void CALL_ABOUT()
{
	...
	cout << endl;
	cout << "	COPYRIGHT (c) 2013 NAVEEN VENKAT";
	cout << endl;
   ...
   cout << "\t\t\t\t.::DISCLAIMER::." << endl << endl;
	cout << "	UNAUTHORISED COPYING, REPRODUCTION, RENTAL, SALE, MODIFICATION," << endl;
	cout << "	FRAGMENTATION, COMPILATION, DISASSEMBLY, PUBLICATION, DERIVATIVE" << endl;
	cout << "	WORKS, REVERSE ENGINEERING OF ANY KIND OF ANY PART OF THIS" << endl;
	cout << "	SOFTWARE IS A CRIME AND CAN BE PENALISED WITH CRIMINAL CHARGES." << endl;
	cout << "	PLEASE READ THE LICENCE AGREEMENT ATTESTED WITH THE SOFTWARE" << endl;
	cout << "	CAREFULLY BEFORE USING THE SOFTWARE. IF YOU DO NOT AGREE WITH ANY OF" << endl;
	cout << "	THE ABOVE TERMS AND THE TERMS MENTIONED IN THE LICENCE AGREEMENT," << endl;
	cout << "	DESTROY ANY COPY OF THE SOFTWARE IMMEDIATELY." << endl;
	cout << endl;
	cout << "================================================================================";
	cout << endl;
	cout << "	EMAIL: nmakes@outlook.com" << endl;
