/*==============================================================
	...
	DEVR version 1.5
	COPYRIGHT (c) February 2013 - November 2013 | NAVEEN VENKAT
	ALL RIGHTS RESERVED
...
================================================================================
	...
	WHAT'S NEW?
         ...
         - Updated the help function (removed _UPDATE and added spacing)
...
float version=1.5; // UPDATE THIS EVERY TIME!!!
fstream REGISTRY;
fstream HISTORY("core",fstream::app);

char INPUT[128];
char USER[32];
char EXE[11]="devr15.exe"; // UPDATE THIS EVERY TIME!!!
...
int main()
{
	...
	cout << "DevR - Development Redefined | version " << version << endl
		  << "Copyright (c) Feb 2013 - Nov 2013 | Naveen Venkat" << endl;
